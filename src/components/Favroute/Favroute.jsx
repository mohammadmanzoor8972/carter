...
class Favroute extends React.PureComponent {
...
const mapStateToProps = (state) => {
    ...
    return { 
      movieList: state.favrouteMovies,
      title : "Favroute Movies"
    };
  }
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(Favroute);
